#
#  Be sure to run `pod spec lint EasySwift.podspec' to ensure this is a
...
DESC
 ...
 # s.license      = "MIT (example)"
  ...
  s.author             = { "Sergii Kutnii" => "mnkutster@gmail.com" }
  # Or just: s.author    = "Sergii Kutnii"
  # s.authors            = { "Sergii Kutnii" => "mnkutster@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Sergii Kutnii"
  ...
  s.source       = { :git => "https://github.com/skutnii/easyasync.git", :tag => "#{s.version}" }
